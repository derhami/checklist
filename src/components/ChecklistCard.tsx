      ...
      <div>
        ...
        <div className="flex items-center justify-between gap-2 mb-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            {checklist.featured && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-800/50">
      ...
      <div className="pt-3 border-t border-stone-100 dark:border-stone-800/80 space-y-3">
        ...
        <div className="flex items-center justify-between pt-1">
          <span className="text-[11px] font-medium text-stone-500 dark:text-stone-400">
            {toPersianDigits(checklist.sections.length)} بخش اصلی • {toPersianDigits(totalItems)} گام
          </span>
          <Link
