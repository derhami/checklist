      ...
      <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-3xl max-w-lg w-full p-6 space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 bg-stone-50 dark:bg-stone-950 p-2.5 rounded-2xl border border-stone-200 dark:border-stone-800">
            ...
            <button
              onClick={handleCopy}
              className="shrink-0 inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-stone-950 text-xs font-bold transition-all shadow-sm active:scale-95"
            >
              {copied ? (
                <>
        ...
        <form onSubmit={handleImportSubmit} className="space-y-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-3 py-2 text-xs text-stone-900 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-amber-500/50"
            />
            <button
              type="submit"
