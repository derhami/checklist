...
export const GuidePage: React.FC = () => {
  ...
  const [textColor, setTextColor] = useState('#1c1917'); // stone-900
  const [bgColor, setBgColor] = useState('#fafaf9'); // stone-50
      ...
      <section className="bg-white dark:bg-stone-900 border border-stone-200/80 dark:border-stone-800 rounded-3xl p-6 space-y-6 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-stone-100 dark:border-stone-800 pb-4">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <div className="w-10 h-10 rounded-xl bg-amber-100 dark:bg-amber-950/60 text-amber-600 dark:text-amber-400 flex items-center justify-center font-bold shrink-0">
          ...
          <span className="self-start sm:self-auto text-xs font-mono font-bold px-3 py-1 bg-amber-50 dark:bg-amber-950/50 text-amber-700 dark:text-amber-300 rounded-full border border-amber-200 dark:border-amber-800 shrink-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4 text-xs font-medium">
            ...
            <div className="pt-2 flex items-center gap-2">
              ...
              <button
                onClick={() => { setTextColor('#1c1917'); setBgColor('#fafaf9'); }}
      ...
      <section className="bg-white dark:bg-stone-900 border border-stone-200/80 dark:border-stone-800 rounded-3xl p-6 space-y-6 shadow-sm">
        ...
        <div className="p-4 bg-stone-50 dark:bg-stone-950 rounded-2xl border border-stone-200/80 dark:border-stone-800 space-y-3 font-mono text-xs">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-bold text-amber-600">{Math.round(baseSize * Math.pow(ratio, 4))}px</span>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-bold text-amber-600">{Math.round(baseSize * Math.pow(ratio, 3))}px</span>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-bold text-amber-600">{Math.round(baseSize * Math.pow(ratio, 2))}px</span>
